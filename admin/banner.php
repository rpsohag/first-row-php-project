  ...
  <input type="hidden" name="id" value="<?php echo $asc['id']?>">
              ...
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="heading" placeholder="Enter Logo name" value="<?php echo $asc['heading']?>" >
                </div>
              </div>
              <div class="row mg-t-20">
...
<?php
  ...
  <form action="banner-post.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row mg-t-20">
                  <label class="col-sm-4 form-control-label">Banner Heading: <span class="tx-danger">*</span></label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control" name="heading" placeholder="Enter Logo name">
                  </div>
                </div>
                <div class="row mg-t-20">
                  <label class="col-sm-4 form-control-label">Summary: <span class="tx-danger">*</span></label>
