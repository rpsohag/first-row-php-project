...
include 'db.php';
  $select = "SELECT COUNT(*) as total,id,title, image FROM service";
...
?>
  ...
  <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item active" href="service.php">Total works</a>
        (<?php echo $asc['total'] ?>)
      </nav>
      ...
      <div class="row row-sm mg-t-20" >
          <div class="col-xl-6">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              <h6 class="card-body-title">Works Content</h6>

  <form action="works-post.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0" style="padding: 0.65rem 0.75rem;">
                  <input type="file" class="form-control" name="image" onchange="document.getElementById('works').src = window.URL.createObjectURL(this.files[0])">
                </div>
              </div><!-- row -->
                <div class="form-layout-footer mg-t-30 text-center">
                                      <a href="service-list.php" class="btn btn-info">Cancel</a>
          ...
          <div class="col-xl-6 mg-t-25 mg-xl-t-0">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-5">
              ...
              <div class="row row-xs mg-t-20">
                <img id="works" width="150" height="150" src="assets/img/no-image.png" alt="">
              </div><!-- row -->
