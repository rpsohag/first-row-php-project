...
<html lang="bn">
  <head>
    ...
    <title>Starlight admin templete</title>
  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="admin-list.php" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <a href="about.php" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="service.php" class="nav-link">Add</a></li>
          <li class="nav-item"><a href="service-list.php" class="nav-link">All service</a></li>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
        <li class="nav-item"><a href="works.php" class="nav-link">Add</a></li>
          <li class="nav-item"><a href="works-list.php" class="nav-link">All Works</a></li>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
        <li class="nav-item"><a href="testimonials.php" class="nav-link">Add</a></li>
          <li class="nav-item"><a href="testimonials-list.php" class="nav-link">All Testimonials</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
        <li class="nav-item"><a href="social.php" class="nav-link">Add</a></li>
          <li class="nav-item"><a href="social-list.php" class="nav-link">List</a></li>
        </ul>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name"><?php echo
                $_SESSION['name']
              ?></span>
