...
?>
  ...
  <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item active" href="service.php"> service</a>
      </nav>
      ...
      <div class="row row-sm mg-t-20">
          <div class="col-xl-6">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              <h6 class="card-body-title">Service Content</h6>
  ...
  <input type="hidden" class="form-control" id="id" value="<?php echo $after_assoc['id']?>" name="id">
                <div class="row mg-t-20">
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control" name="title" placeholder="Enter Logo name" value="<?php echo $after_assoc['title']?>">
                  </div>
                </div>
                <div class="row mg-t-20">
                  <label class="col-sm-4 form-control-label">Summary: <span class="tx-danger">*</span></label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <textarea  cols="35" rows="3" name="description" style="width: 100%;" ><?php echo $after_assoc['description']?> </textarea>
                  </div>
                </div>
                <div class="row"> 
          ...
          <div class="col-xl-6 mg-t-25 mg-xl-t-0">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-5">
              ...
              <div class="row row-xs mg-t-20">
                <img id="logo" width="150" height="150" src="<?php echo"upload/service/".$after_assoc['image'];?>" alt="">
              </div><!-- row -->
