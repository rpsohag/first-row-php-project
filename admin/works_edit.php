...
?>
  ...
  <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item active" href="works.php"> works</a>
      </nav>
  ...
  <form action="works-update.php" method="post" enctype="multipart/form-data">
  <input type="hidden" class="form-control" id="id" value="<?php echo $after_assoc['id']?>" name="id">
                ...
                <div class="form-layout-footer mg-t-30 text-center">
                  <a href="works-list.php" class="btn btn-info">Cancel</a>
          ...
          <div class="col-xl-6 mg-t-25 mg-xl-t-0">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-5">
              ...
              <div class="row row-xs mg-t-20">
                <img id="logo" width="150" height="150" src="<?php echo"upload/works/".$after_assoc['image'];?>" alt="">
              </div><!-- row -->
