...
include 'db.php';
  $select = "SELECT COUNT(*) as total,id,title,description, image FROM service";
...
?>
  ...
  <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item active" href="service.php">Total service</a>
        (<?php echo $asc['total'] ?>)
      </nav>
  ...
  <form action="service-post.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row mg-t-20">
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <textarea  cols="35" rows="3" name="description" style="width: 100%;" > </textarea>
                  </div>
                </div>
                <div class="row"> 
